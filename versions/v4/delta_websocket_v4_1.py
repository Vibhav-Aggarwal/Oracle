...
TRAIL_DIST = 1.5
POSITION_SIZE = 0.65
LOG = "/home/vibhavaggarwal/delta_websocket_v4_1.log"
...
MIN_CONFIDENCE = 0.4          # Minimum confidence to enter (0-1)
...
def find_best_advanced(equity):
    ...
    for t in ticker_list:
        ...
        # Skip low confidence
        # DEBUG: log every scan result
        if confidence > 0.25:
            log(f"[SCAN] {sym} | Conf:{confidence:.0%} | Sigs:{signals[:3]}")
